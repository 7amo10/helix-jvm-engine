...
```java
import com.helix.experiments.ExperimentRunner;
import com.helix.experiments.jit.JitCompilationExperiment;
import com.helix.experiments.metaspace.MetaspaceLeakExperiment;

public class ExperimentCodeExample {

    public static void main(String[] args) {
        System.out.println("--- Running Metaspace Cleanup Experiment ---");
        MetaspaceLeakExperiment metaspaceExp = new MetaspaceLeakExperiment();
        metaspaceExp.runFixedScenario(50);

        System.out.println("--- Running JIT Tier Compilation Experiment ---");
        JitCompilationExperiment jitExp = new JitCompilationExperiment();
        jitExp.runTieredCompilationScenario(15000);
    }
}
```
