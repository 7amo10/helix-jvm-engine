...
5. **Multi-Tenant Security**: MicroProfile JWT 2.1 tokens enforce strict role-based access control (`ADMIN`, `OPERATOR`, `ANALYST`) across all rule compilation, execution, and inspection endpoints.
